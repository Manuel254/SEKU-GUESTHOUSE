...
<section class="container bg-light py-2">
    ...
    <h2 class="text-center">SOFT DRINKS</h2>
      <!-- Meals available -->
              <?php
                if (!$connect){
                ...
                while($row=mysqli_fetch_assoc($sql)){
                  ...
                  echo '<form action="sub-meal4.php?action=add&id='.$row['FOOD_ID'].'" method="POST">'; 
                    echo '<div class="card shadow">';
                        echo '<img src="admin/images/'.$row["IMAGES"].'" class="card-img-top" alt="Soft drinks" width="300px" height="200px">';
