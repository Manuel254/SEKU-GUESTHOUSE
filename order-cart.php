...
<html>
    ...
    <body>
      ...
      <?php
          ...
          ?>
         		<tr>
                    <td align="center"><a href="meals.php" class="btn btn-success"><i class="fas fa-cart-plus"></i>&nbsp;&nbsp;Continue shopping</a></td>
                    <td colspan="2" align="center"><strong>Total</strong></td>
                    <td align="left"><strong>Ksh. <?php echo number_format($total, 2); ?></strong></td>
                     <td align="center"><a href="checkout.php" class="btn btn-info mx-2 <?= ($total > 1) ?"":"disabled" ?>"<i class="far fa-credit-card"></i>&nbsp;&nbsp;Checkout</a></td>
                </tr>
         </table>
       </div>
      </section>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
 ...
 <script type="text/javascript" src="update_cart_ajax.js"></script>
</body>
</html>
