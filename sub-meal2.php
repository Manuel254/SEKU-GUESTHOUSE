...
<section class="container bg-light py-2">
       <div>
           <!-- Search bar -->
      <form action="search.php" method="POST" class="form-inline my-2">
      ...
      <!-- Meals available -->
              <?php
                ...
                while($row=mysqli_fetch_assoc($sql)){
                  ...
                  echo '<form action="sub-meal2.php?action=add&id='.$row['FOOD_ID'].'" method="POST">'; 
                    echo '<div class="card shadow">';
                        echo '<img src="admin/images/'.$row["IMAGES"].'" class="card-img-top" alt="Snacks" width="300px" height="200px">';
