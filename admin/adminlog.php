...
<head>
    ...
    <title>SEKU GUEST HOUSE | ADMIN</title>
     <link href="css/bootstrap.min.css" rel="stylesheet">
     <link rel="stylesheet" type="text/css" href="css/log.css">
    <link rel="stylesheet" type="text/css" href="file:///D:/fontawesome-free-5.12.0-web/css/all.css"/>
...
<body> 
        ...
        <div class="header"><h2>SEKU GUEST HOUSE</h2></div>
            <h6>ADMIN LOGIN</h6>
            <?php
