      ...
      <!-- Meals available -->
              <?php
                ...
                while($row=mysqli_fetch_assoc($sql)){
                  ...
                  echo '<form action="sub-meal3.php?action=add&id='.$row['FOOD_ID'].'" method="POST">'; 
                    echo '<div class="card shadow">';
                        echo '<img src="admin/images/'.$row["IMAGES"].'" class="card-img-top" alt="Desserts" width="300px" height="200px">';
